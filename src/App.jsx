                ...
                <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center mr-3">
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244"
                    />
                  </svg>
                </div>
...
print(result["choices"][0]["message"]["content"])`}
      ...
      <footer className="container mx-auto px-4 py-8 border-t border-gray-200">
        <div className="text-center text-gray-600">
            ...
            <p className="text-xl font-medium text-gray-700 mb-2">Desarrollado por Manuel González Pérez</p>
          <p className="text-sm mb-4">
            Esta aplicación utiliza la API gratuita de GitHub Models para acceder a los modelos de OpenAI
          </p>
            <div className="flex items-center justify-center space-x-6">
              <a
                href="https://www.linkedin.com/in/manuel-gonzalez-4a6ab7212/"
                target="_blank"
              ...
              <a
                href="https://github.com/ManuelGonzalez709/"
                target="_blank"
                rel="noopener noreferrer"
